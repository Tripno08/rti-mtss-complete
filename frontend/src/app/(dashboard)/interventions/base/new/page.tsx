...
export default function NewBaseInterventionPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      await api.post('/interventions/base', data);
      toast.success('Intervenção base criada com sucesso!');
      router.push('/interventions/base');
    } catch (error) {
      console.error('Erro ao criar intervenção base:', error);
      toast.error('Erro ao criar intervenção base. Tente novamente.');
    } finally {
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-3xl font-bold">Nova Intervenção Base</h1>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Preencha os campos abaixo para criar uma nova intervenção base
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
